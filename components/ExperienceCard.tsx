...
const ExperienceCard = (props: Props) => {
    ...
    return (
        ...
        [500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100
        opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden'>
            ...
            <div className='px-0 md:px-10'>
                <h4 className='text-4xl font-light'>Founder of InJoy Labs</h4>
                <p className='font-bold text-2xl mt-1'>InJoy Labs</p>
