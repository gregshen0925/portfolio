...
const Skills = ({ skills }: Props) => {
  return (
    ...
    >
      ...
      <h3 className="absolute top-36 uppercase tracking-[3px] text-gray-500 text-sm md:text-xs">
        &nbsp;Click to show name
      </h3>

      <motion.div
        className="grid grid-cols-4 gap-2 md:gap-3 xl:gap-4 w-[350px] 
            h-[200px] md:w-[500px] md:h-[350px] xl:w-[500px] xl:h-[350px]"
      >
